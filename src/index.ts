import { PluginDefinition, Context, CallTemplateFunctionArgs } from '@yaakapp/api';
...
function evaluateCondition(condition: string): boolean {
  ...
  // If we can't parse it, treat non-empty strings as truthy
 ...
 */
function compareValues(left: string, right: string, operator: string): boolean {
